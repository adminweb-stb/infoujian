                ...
                <div class="col-md-11 col-lg-10">
                    ...
                    <?php if (isset($_SESSION['success'])): ?>
                        <div class="alert alert-success alert-dismissible fade show shadow-sm border-0" role="alert">
                            <strong><i class="bi bi-check-circle-fill"></i> Sukses!</strong>
                    ...
                    <?php if (isset($_SESSION['error'])): ?>
                        <div class="alert alert-danger alert-dismissible fade show shadow-sm border-0" role="alert">
                            <strong><i class="bi bi-exclamation-triangle-fill"></i> Gagal!</strong>
                    ...
                    <div class="glass-card p-4 mb-4 border-primary" style="border-left: 5px solid #4f46e5 !important;">
                        ...
                        <form id="configForm">
                            <div class="row g-3 align-items-end">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="cfg-exam" name="active_exam">
                                        <option value="uts" <?php if ($active_exam == 'uts')
                                            echo 'selected'; ?>>Ujian Tengah
                                            Semester (UTS)</option>
                                        <option value="uts_susulan" <?php if ($active_exam == 'uts_susulan')
                                            echo 'selected'; ?>>Susulan UTS</option>
                                        <option value="uas" <?php if ($active_exam == 'uas')
                                            echo 'selected'; ?>>Ujian Akhir
                                            Semester (UAS)</option>
                                        <option value="uas_susulan" <?php if ($active_exam == 'uas_susulan')
                                            echo 'selected'; ?>>Susulan UAS</option>
                                        <option value="remedial" <?php if ($active_exam == 'remedial')
                                            echo 'selected'; ?>>
                                            Remedial</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="cfg-period" name="active_period">
                                        <option value="ganjil" <?php if ($active_period == 'ganjil')
                                            echo 'selected'; ?>>
                                            Semester Ganjil (1, 3, 5, 7)</option>
                                        <option value="genap" <?php if ($active_period == 'genap')
                                            echo 'selected'; ?>>Semester
                                            Genap (2, 4, 6, 8)</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="form-text mt-2 text-danger small">⚠️ Perhatian: Menyimpan pengaturan ini mengubah
                                Judul Web dan Sinkronisasi Jadwal bagi seluruh Mahasiswa secara Instan.</div>
                        </form>
                    </div>
                            ...
                            <div class="col-12">
                                <div class="glass-card p-4">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <button class="btn btn-warning btn-sm me-2 fw-bold text-dark"
                                                onclick="openLiveEditor(<?php echo $sem; ?>)">Lihat & Edit Data</button>
                                            <button class="btn btn-outline-primary btn-sm" data-bs-toggle="collapse"
                                                data-bs-target="#upload-<?php echo $sem; ?>">Upload Baru</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="collapse mt-3" id="upload-<?php echo $sem; ?>">
                                        <form action="import" method="POST" enctype="multipart/form-data"
                                            ...
                                            <div class="form-text mt-1 text-danger">⚠️ Perhatian: Mengunggah file baru akan
                                                menghapus data lama di semester ini.</div>
                                        </form>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered mb-0 align-middle" id="le-table"
                            ...
                            <tbody id="le-tbody">
                                <tr>
                                    <td colspan="7" class="text-center p-4">Memuat data...</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="modal-body">
                    <form id="editForm">
                        ...
                        <div class="row g-2 mb-2">
                            <div class="col-6"><label class="form-label small mb-1 fw-bold">Hari</label><input
                                    type="text" class="form-control form-control-sm" id="edit-hari" name="hari"
                                    required></div>
                            <div class="col-6"><label class="form-label small mb-1 fw-bold">Tanggal</label><input
                                    type="text" class="form-control form-control-sm" id="edit-tanggal" name="tanggal"
                                    required></div>
                        </div>
                        <div class="row g-2 mb-2">
                            <div class="col-4"><label class="form-label small mb-1 fw-bold">Sesi</label><input
                                    type="text" class="form-control form-control-sm" id="edit-sesi" name="sesi"></div>
                            <div class="col-8"><label class="form-label small mb-1 fw-bold">Jam</label><input
                                    type="text" class="form-control form-control-sm" id="edit-jam" name="jam" required>
                            </div>
                        </div>
                        <div class="mb-2"><label class="form-label small mb-1 fw-bold">Mata Kuliah</label><input
                                type="text" class="form-control form-control-sm" id="edit-matkul" name="matkul"
                                required></div>
                        <div class="row g-2 mb-2">
                            <div class="col-4"><label class="form-label small mb-1 fw-bold">Kelas</label><input
                                    type="text" class="form-control form-control-sm" id="edit-kelas" name="kelas"></div>
                            <div class="col-8"><label class="form-label small mb-1 fw-bold">Dosen</label><input
                                    type="text" class="form-control form-control-sm" id="edit-dosen" name="dosen"></div>
                        </div>
                        <div class="mb-4"><label class="form-label small mb-1 fw-bold">Link Server</label><input
                                type="url" class="form-control form-control-sm" id="edit-link" name="link_server"></div>

                        <div class="d-flex justify-content-between">
                            <button type="button" class="btn btn-sm btn-danger px-3 fw-bold"
                                onclick="deleteJadwal()">Hapus</button>
                            <div>
